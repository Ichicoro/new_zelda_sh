...
export default function Home() {
  return (
    <div className="flex flex-col sm:flex-row w-full mt-8 gap-5 sm:gap-14 items-start">
      <div className="w-[147px] mx-auto">
        <Lair className="w-[147px]" />
      </div>
      <main className="flex flex-col gap-4">
        <div className="flex flex-col justify-center items-center sm:items-start">
          <h1 className="font-sans leading-tight">ZELDA&apos;S LAIR</h1>
          <div className={`${germania.className} text-2xl flex flex-row sm:flex-col gap-3 sm:gap-0`}>
        ...
        <div className="pt-2.5 flex flex-col gap-3">
          <h2 className="font-sans">ABOUT</h2>
          <p className="text-lg">
